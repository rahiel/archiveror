...
var presentButton = {label: "Go to archived page",
...
function presentArchive(url) {
    ...
    if (url in data) {
        button.state("tab", presentButton);
...
exports.main = function() {
    ...
    bookmarks.on("visited", presentArchive);
...
exports.onUnload = function() {
    ...
    bookmarks.removeListener("visited", presentArchive);
